...
const FunctionalConponentDemo = function() {
    return(
<Container className="main">
    ...
    <p>Functional components are the primarily tool in React to build a small, modular piece of your page.. </p>
    <dl>
        <dt>Can use state</dt>
        ...
        <dt>return()</dt>
        <dd>Must return a single element, but this element may have nested elements insisde.</dd>
    </dl>
    <h1>Functional Syntax verus Arrow Function</h1>
        </Col>
    </Row>
    <hr />
    <h1>Challenge</h1>
        ...
        <div>
            <Card>
                ...
                <CardBody>
                    ...
                    <CardSubtitle>A JS Libraby</CardSubtitle>
